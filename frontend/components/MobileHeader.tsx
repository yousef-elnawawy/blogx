...
export default function MobileHeader() {
  ...
  const navLinks = [
    ...
    { label: "Following", href: "/following", icon: UserCheck, color: "primary" },
    {
      ...
      icon: AtSign,
      color: "blue",
      activeColor: "text-sky-500 bg-sky-500/10 font-bold",
      hoverColor: "hover:bg-sky-500/10 hover:text-sky-500",
    ...
    },
    {
      ...
      icon: Bookmark,
      color: "green",
      activeColor: "text-emerald-500 bg-emerald-500/10 font-bold",
