          ...
          {[
            {
              ...
              icon: Heart,
              iconColor: "text-brand-like",
              bgColor: "bg-brand-like-subtle",
            },
            {
            ...
            },
            {
              ...
              icon: UserPlus,
              iconColor: "text-brand-following",
              bgColor: "bg-brand-following-subtle",
            },
            {
              ...
              icon: AtSign,
              iconColor: "text-brand-mention",
              bgColor: "bg-brand-mention-subtle",
            },
            {
              key: "shares" as const,
