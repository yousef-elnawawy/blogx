...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('/posts/{id}/comments/{commentId}', [PostController::class, 'updateComment']);
    ...
    Route::post('/posts/{id}/comments/{commentId}/pin', [PostController::class, 'togglePinComment']);
    Route::post('/posts/{id}/comments/{commentId}/heart', [PostController::class, 'toggleHeartComment']);
    ...
    Route::get('/bookmark-collections', [\App\Http\Controllers\Api\BookmarkCollectionController::class, 'index']);
    Route::post('/bookmark-collections', [\App\Http\Controllers\Api\BookmarkCollectionController::class, 'store']);
    Route::put('/bookmark-collections/{id}', [\App\Http\Controllers\Api\BookmarkCollectionController::class, 'update']);
    Route::delete('/bookmark-collections/{id}', [\App\Http\Controllers\Api\BookmarkCollectionController::class, 'destroy']);
    Route::post('/bookmarks/assign-collection', [\App\Http\Controllers\Api\BookmarkCollectionController::class, 'assignBookmark']);
